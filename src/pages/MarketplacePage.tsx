...
export default function MarketplacePage() {
  ...
  useEffect(() => {
    ...
    // Restrict to favorited assets if the watchlist filter is on
    if (favoritesOnly) {
      result = result.filter(asset => favoritedIds.has(asset.id));
    }
  ...
  }, [assets, searchQuery, selectedCategory, priceRange, verifiedOnly, sortOption, favoritesOnly, favoritedIds]);
